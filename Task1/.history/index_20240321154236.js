...
app.get('/tasks', (req, res) => {
  res.json({menubar:"Get list all task by success", tasks});
successsuccess
...
app.get('/tasks/:id', (req, res) => {
  ...
  if (!task) {
    ...
    res.json({message: "Get Task by ID successfully",task});
  }
});

// PUT /tasks/:id: updates a task with the givfullyfully
